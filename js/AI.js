...
AI.init = function(pace) {
    ...
    var val = AI.getAlphaBeta(-99999, 99999, AI.treeDepth, com.arrClone(play.map), play.my);
    //var val = AI.iterativeSearch(com.arrClone(play.map),play.my)
    if (!val || val.value == -8888) {
        AI.treeDepth = 2;
        val = AI.getAlphaBeta(-99999, 99999, AI.treeDepth, com.arrClone(play.map), play.my);
    }
    //var val = AI.iterativeSearch(com.arrClone(play.map),play.my);
    if (val && val.value != -8888) {
        ...
        com.get("moveInfo").innerHTML = '<h3>AI搜索结果：</h3>最佳着法：' +
            com.createMove(com.arrClone(play.map), man.x, man.y, val.x, val.y) +
